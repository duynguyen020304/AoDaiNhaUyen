...
import { Package, Users, Shield, FolderTree, LogOut, Menu, Image, LayoutDashboard, Bot, ClipboardList, Settings2, Tag, FileSearch, FileText, Newspaper, Megaphone, Send, PanelLeftClose, PanelLeftOpen, MessageSquareText, Sparkles, Activity } from 'lucide-react'
...
const NAV_ITEMS = [
  ...
  { to: '/admin/hermes-events', icon: Activity, label: 'Event Hermes', end: true },
...
export function AdminLayout() {
  ...
  const isChatPage = location.pathname.startsWith('/admin/ai-chat') || location.pathname === '/admin/hermes-reports' || location.pathname === '/admin/hermes-events'
