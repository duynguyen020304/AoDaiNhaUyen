...
public sealed class SafetyGate : ISafetyGate
{
  ...
  private static readonly Dictionary<string, (RiskLevel Level, bool RequiresConfirmation)> DefaultMap = new()
  {
    ...
    ["generate_blog_images"] = (RiskLevel.Low, false),
    ...
    ["publish_facebook_post"] = (RiskLevel.High, true),
    ["delete_facebook_post"] = (RiskLevel.High, true),
    ...
    ["list_facebook_conversations"] = (RiskLevel.Read, false),
    ["list_facebook_conversation_messages"] = (RiskLevel.Read, false),
    ["send_facebook_message"] = (RiskLevel.Medium, true),
