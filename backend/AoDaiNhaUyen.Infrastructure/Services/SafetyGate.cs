...
public sealed class SafetyGate : ISafetyGate
{
  ...
  private static readonly Dictionary<string, (RiskLevel Level, bool RequiresConfirmation)> DefaultMap = new()
  {
    ...
    ["list_collections"] = (RiskLevel.Read, false),
    ["get_collection"] = (RiskLevel.Read, false),
    ["create_collection"] = (RiskLevel.Low, false),
    ["update_collection"] = (RiskLevel.Medium, true),
    ["delete_collection"] = (RiskLevel.High, true),
    ["restore_collection"] = (RiskLevel.Medium, true),
    ["add_product_to_collection"] = (RiskLevel.Medium, true),
    ["remove_product_from_collection"] = (RiskLevel.Medium, true),
