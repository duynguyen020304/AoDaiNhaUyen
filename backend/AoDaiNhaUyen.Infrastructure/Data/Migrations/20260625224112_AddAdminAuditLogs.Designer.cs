...
namespace AoDaiNhaUyen.Infrastructure.Data.Migrations
{
    ...
    [Migration("20260625224112_AddAdminAuditLogs")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("AoDaiNhaUyen.Domain.Entities.AdminAuditLog", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
                    ...
                    b.HasIndex("ActionType", "CreatedAt")
                        .HasDatabaseName("idx_admin_audit_logs_action_created_at");

                    b.HasIndex("ActorUserId", "CreatedAt")
                        .HasDatabaseName("idx_admin_audit_logs_actor_created_at");

                    b.HasIndex("CreatedAt", "Success")
                        .HasDatabaseName("idx_admin_audit_logs_created_success");

                    b.HasIndex("StatusCode", "CreatedAt")
                        .HasDatabaseName("idx_admin_audit_logs_status_created_at");

                    b.HasIndex("EntityType", "EntityId", "CreatedAt")
                        .HasDatabaseName("idx_admin_audit_logs_entity_created_at");
            ...
            modelBuilder.Entity("AoDaiNhaUyen.Domain.Entities.Collection", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
                    ...
                    b.HasIndex("IsPublished")
                        .HasDatabaseName("idx_collections_is_published");

                    b.HasIndex("Slug")
                        .IsUnique();

                    b.HasIndex("SortOrder")
                        .HasDatabaseName("idx_collections_sort_order");

                    b.ToTable("collections", (string)null);
                });

            modelBuilder.Entity("AoDaiNhaUyen.Domain.Entities.CollectionProduct", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
            ...
            modelBuilder.Entity("AoDaiNhaUyen.Domain.Entities.HermesActionAudit", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
                    ...
                    b.HasIndex("EventOutboxId")
                        .HasDatabaseName("idx_hermes_action_audit_event_outbox_id");

                    b.HasIndex("ResponseStatus", "ExecutedAt")
                        .HasDatabaseName("idx_hermes_action_audit_status_executed_at");

                    b.HasIndex("RunId", "ExecutedAt")
                        .HasDatabaseName("idx_hermes_action_audit_run_executed_at");

                    b.HasIndex("Method", "Path", "ExecutedAt")
                        .HasDatabaseName("idx_hermes_action_audit_method_path_executed_at");

                    b.ToTable("hermes_action_audit", (string)null);
                });
            ...
            modelBuilder.Entity("AoDaiNhaUyen.Domain.Entities.SocialAccountConnection", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
                    ...
                    b.Property<DateTimeOffset?>("AutoReplyIgnoreBefore")
                        .HasColumnType("timestamp with time zone")
                        .HasColumnName("auto_reply_ignore_before");
                    ...
                    b.HasIndex("ZernioProfileId")
                        .HasDatabaseName("idx_social_accounts_zernio_profile_id");

                    b.HasIndex("Provider", "ZernioAccountId")
                        .IsUnique()
                        .HasDatabaseName("idx_social_accounts_provider_account_unique")
                        .HasFilter("NOT is_deleted");

                    b.HasIndex("Platform", "IsActive", "DisplayName")
                        .HasDatabaseName("idx_social_accounts_platform_active_name");

                    b.ToTable("social_account_connections", (string)null);
                });

            modelBuilder.Entity("AoDaiNhaUyen.Domain.Entities.SocialAutoReplyBatch", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
                    ...
                    b.Property<string>("MessageIdsJson")
                        .IsRequired()
                        .HasColumnType("jsonb")
                        .HasColumnName("message_ids_json");
                    ...
                    b.HasIndex("Status", "WindowEndsAt")
                        .HasDatabaseName("idx_social_auto_reply_batches_status_window");
                    ...
                    b.ToTable("social_auto_reply_batches", null, t =>
                        {
                            t.HasCheckConstraint("ck_social_auto_reply_batches_status", "status IN ('pending','processing','queued','replied','cancelled','failed')");
                        });
                });

            modelBuilder.Entity("AoDaiNhaUyen.Domain.Entities.SocialAutomationState", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
                    ...
                    b.HasIndex("Key")
                        .IsUnique()
                        .HasDatabaseName("idx_social_automation_states_key_unique")
                        .HasFilter("NOT is_deleted");

                    b.ToTable("social_automation_states", (string)null);
                });

            modelBuilder.Entity("AoDaiNhaUyen.Domain.Entities.SocialInboxComment", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
                    ...
                    b.Property<bool>("AuthorIsOwner")
                        .HasColumnType("boolean")
                        .HasColumnName("author_is_owner");
                    ...
                    b.HasIndex("ParentCommentId")
                        .HasDatabaseName("idx_social_inbox_comments_parent");

                    b.HasIndex("Platform", "AccountId", "CommentId")
                        .IsUnique()
                        .HasDatabaseName("idx_social_inbox_comments_unique")
                        .HasFilter("NOT is_deleted");

                    b.HasIndex("Platform", "AccountId", "PostId", "CreatedTime")
                        .HasDatabaseName("idx_social_inbox_comments_post_created");

                    b.ToTable("social_inbox_comments", (string)null);
                });

            modelBuilder.Entity("AoDaiNhaUyen.Domain.Entities.SocialInboxConversation", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
                    ...
                    b.Property<string>("ParticipantPicture")
                        .HasMaxLength(1000)
                        .HasColumnType("character varying(1000)")
                        .HasColumnName("participant_picture");
                    ...
                    b.HasIndex("Status", "UpdatedTime")
                        .HasDatabaseName("idx_social_inbox_conversations_status_updated");

                    b.HasIndex("Platform", "AccountId", "ConversationId")
                        .IsUnique()
                        .HasDatabaseName("idx_social_inbox_conversations_unique")
                        .HasFilter("NOT is_deleted");

                    b.HasIndex("Platform", "AccountId", "UpdatedTime")
                        .HasDatabaseName("idx_social_inbox_conversations_account_updated");

                    b.ToTable("social_inbox_conversations", (string)null);
                });

            modelBuilder.Entity("AoDaiNhaUyen.Domain.Entities.SocialInboxMessage", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
                    ...
                    b.HasIndex("Platform", "AccountId", "MessageId")
                        .IsUnique()
                        .HasDatabaseName("idx_social_inbox_messages_unique")
                        .HasFilter("NOT is_deleted");

                    b.HasIndex("Platform", "AccountId", "ConversationId", "CreatedAt")
                        .HasDatabaseName("idx_social_inbox_messages_thread_created");

                    b.ToTable("social_inbox_messages", (string)null);
                });

            modelBuilder.Entity("AoDaiNhaUyen.Domain.Entities.SocialInboxSyncCursor", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
                    ...
                    b.HasIndex("Resource", "Platform", "AccountId", "ProfileId")
                        .IsUnique()
                        .HasDatabaseName("idx_social_inbox_sync_cursors_unique")
                        .HasFilter("NOT is_deleted");

                    b.ToTable("social_inbox_sync_cursors", (string)null);
                });

            modelBuilder.Entity("AoDaiNhaUyen.Domain.Entities.SocialWebhookReceipt", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
                    ...
                    b.HasIndex("ReplyStatus", "ReceivedAt")
                        .HasDatabaseName("idx_social_webhook_receipts_status_received");

                    b.HasIndex("Platform", "AccountId", "MessageId")
                        .IsUnique()
                        .HasDatabaseName("idx_social_webhook_receipts_message_unique")
                        .HasFilter("NOT is_deleted");

                    b.HasIndex("Provider", "EventType", "ExternalEventId")
                        .IsUnique()
                        .HasDatabaseName("idx_social_webhook_receipts_event_unique")
                        .HasFilter("external_event_id IS NOT NULL AND NOT is_deleted");

                    b.HasIndex("Platform", "AccountId", "ThreadId", "ReceivedAt")
                        .HasDatabaseName("idx_social_webhook_receipts_thread_received");

                    b.ToTable("social_webhook_receipts", null, t =>
                        {
                            t.HasCheckConstraint("ck_social_webhook_receipts_reply_status", "reply_status IN ('pending','skipped','batched','replied','failed')");
                        });
                });
            ...
            modelBuilder.Entity("AoDaiNhaUyen.Domain.Entities.AdminAuditLog", b =>
                {
                    b.HasOne("AoDaiNhaUyen.Domain.Entities.User", "ActorUser")
            ...
            modelBuilder.Entity("AoDaiNhaUyen.Domain.Entities.CollectionProduct", b =>
                {
                    b.HasOne("AoDaiNhaUyen.Domain.Entities.Collection", "Collection")
                        .WithMany("Products")
