...
namespace AoDaiNhaUyen.Infrastructure.Data.Migrations
{
    ...
    [Migration("20260623194052_AddSocialInboxMessageStoredImage")]
    partial class AddSocialInboxMessageStoredImage
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("AoDaiNhaUyen.Domain.Entities.HermesAgentTraceStep", b =>
                {
                    ...
                    b.HasIndex("RunId", "Kind")
                        .HasDatabaseName("idx_hermes_trace_steps_run_kind");
            ...
            modelBuilder.Entity("AoDaiNhaUyen.Domain.Entities.SocialInboxMessage", b =>
                {
                    ...
                    b.Property<string>("StoredImageKey")
                        .HasMaxLength(500)
                        .HasColumnType("character varying(500)")
                        .HasColumnName("stored_image_key");

                    b.Property<string>("StoredImageMimeType")
                        .HasMaxLength(100)
                        .HasColumnType("character varying(100)")
                        .HasColumnName("stored_image_mime_type");
